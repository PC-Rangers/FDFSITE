           ...
           <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <asp:Button runat="server" id="ibBru0R" CssClass="glyphicon glyphicon-edit" Text="Rediger"/> </td>
                        <%//td> <asp:ImageButton runat="server" id="ibBru0R" CssClass="glyphicon glyphicon-edit" AlternateText="Rediger" /> </td%>
                        <td> <asp:Button runat="server" id="ibBru0S" CssClass="glyphicon glyphicon-edit" Text="Slet"/> </td>
