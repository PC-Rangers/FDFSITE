<%@ Page Language="C#" Inherits="FDFk7.adminNyereservation" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<title>FDF K7 Frihavn - adminNyereservation</title>
            ...
            <div class="col-sm-6 top-buffer-small">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p class="text-muted"><strong>(Husk ikke at betale medie licens)</strong></p>
